    ...
    <div className="min-h-screen flex items-center justify-center bg-background">
      <div className="p-6 max-w-md w-full mx-auto">
        <div className="flex justify-center mb-6 gap-2">
          <button
            className={`px-4 py-2 rounded-t ${mode === "login" ? "bg-blue-600 text-white" : "bg-gray-200 text-gray-700"}`}
          ...
          <button
            className={`px-4 py-2 rounded-t ${mode === "signup" ? "bg-blue-600 text-white" : "bg-gray-200 text-gray-700"}`}
